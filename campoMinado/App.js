...
import {createdMinedBoard, cloneBoard, openField, hadExplosion, wonGame, showMines, invertFlag, flagsUsed} from './src/Functions'
...
export default class App extends React.Component {
  ...
  minesAmount = () => {
    ...
    const rows = params.getColumnsAmount()
