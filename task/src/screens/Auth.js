...
export default class Auth extends Component {
    ...
    render() {
        ...
        validations.push(this.state.password && this.state.password.length >=1)
        ...
        return (
            <ImageBackground source={backgroundImage} style={styles.background}>
                ...
                <View style={styles.formContainer}>
                    ...
                    {this.state.stageNew && <AuthInput icon='asterisk' secureTextEntry={true} placeholder='Confirma senha' style={styles.input} value={this.state.confirmPassword} onChangeText={confirmPassword => this.setState({ confirmPassword })} />}
                ...
                <TouchableOpacity style={ { padding: 10 } } onPress={() => this.setState({ stageNew: !this.state.stageNew } )}>
                    <Text style={styles.buttonText}>{this.state.stageNew ? 'Ja possui conta?' : 'Ainda não possui conta'}</Text>
                </TouchableOpacity>
            </ImageBackground>
        )
    }
