...
import { StyleSheet, Text, View, TextInput, DatePickerIOS, DatePickerAndroid, Modal, TouchableWithoutFeedback, TouchableOpacity, Alert, Platform } from 'react-native';
...
export default class AddTask extends Component {
    ...
    save = () => {
        if (!this.state.desc.trim()) {
            Alert.alert('Dados inválidos', 'Informe uma descrição para a task')
            return 
        }
